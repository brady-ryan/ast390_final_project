...
b = Planet("b",0.16,0.105*AU,13.965*DAY)
g = Planet('g',0.06,0.133*AU,20*DAY)
c = Planet('c',0.03,0.195*AU,35.362*DAY)
h = Planet('h',0.23,0.243*AU,49.41*DAY)
d = Planet('d',0.08,0.374*AU,94.11*DAY)
e = Planet('e',0.18,0.538*AU,162.87*DAY)
f = Planet('f',0.16,1.334*AU,636*DAY)
